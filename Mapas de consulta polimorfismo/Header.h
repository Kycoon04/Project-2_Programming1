...
public:
	...
	virtual void GraficarParametro(CImg<unsigned char>& imagen,eslabon_Lista** Lista);
	virtual int busquedaBinaria(eslabon_Lista** Lista, string elem, CImg<unsigned char>& imagen, bool tipo);
	virtual void GraficarDosParametro(CImg<unsigned char>& imagen, eslabon_Lista** Lista);
	//virtual void busquedaBinariaParametro(eslabon_Lista** Lista, string elem, CImg<unsigned char>&imagen, bool tipo)=0;
...
public:
	...
	int busquedaBinaria(eslabon_Lista** Lista, string elem, CImg<unsigned char>& imagen, bool tipo);
};
...
public:
	...
	void Mostrar_Indice(eslabon_Lista** Indice);
	int busquedaBinaria(eslabon_Lista** Lista, string elem, CImg<unsigned char>& imagen, bool tipo);
	void busquedaBinariaParametro(CImg<unsigned char>& imagen, eslabon_Lista** Lista);
};
