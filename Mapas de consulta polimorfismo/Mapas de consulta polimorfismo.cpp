...
int main()
{
    int options; bool resp = false; int opcion;
    ...
    while (resp == false) {
        ...
        if (options == 9) {
            ...
            switch (opcion) {
            case 1:
                obj1.GraficarParametro(img,ListaP); break;
            case 2:
                obj2.GraficarParametro(img, ListaE); break;
            case 3:
                obj3.GraficarParametro(img, ListaC); break;
            default: cout << "Digite el numero correcto" << endl;
            }
        }
        if (options == 10) {
            ...
            switch (opcion) {
            case 1:
                obj2.busquedaBinariaParametro(img, ListaE); break;
            case 2:
                obj3.busquedaBinariaParametro(img, ListaC); break; break;
            default: cout << "Digite el numero correcto" << endl;
            }
        }
    }
