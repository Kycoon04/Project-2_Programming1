...
public:
	...
	void Parametro_Poblados(struct eslabon_Poblados** Lista, CImg<unsigned char>& imagen);
	void busquedaBinaria_PobladosHabitantes(struct eslabon_Poblados** Lista, string elem, CImg<unsigned char>& imagen);
};
...
public:
	...
	void Parametro_Escuelas(struct eslabon_Escuelas** Lista, CImg<unsigned char>& imagen);
	void busquedaBinaria_EscuelasHabitantes(struct eslabon_Escuelas** Lista, string elem, CImg<unsigned char>& imagen);
	void DosParametro_Escuelas(struct eslabon_Escuelas** Lista, CImg<unsigned char>& imagen);
	void DosbusquedaBinaria_EscuelasHabitantes(struct eslabon_Escuelas** Lista, string elem, CImg<unsigned char>& imagen, string provincia);
};
//_____________________________________________________________________________________________________________________________________
//_____________________________________________________________________________________________________________________________________
//Clase Lista Colegio
...
public:
	...
	void Graficar_Colegio(CImg<unsigned char>& imagen);
	...
	void Parametro_Colegio(struct eslabon_Colegio** Lista, CImg<unsigned char>& imagen);
	void busquedaBinaria_ColegioHabitantes(struct eslabon_Colegio** Lista, string elem, CImg<unsigned char>& imagen);
	void DosParametro_Colegio(struct eslabon_Colegio** Lista, CImg<unsigned char>& imagen);
	void DosbusquedaBinaria_ColegioHabitantes(struct eslabon_Colegio** Lista, string elem, CImg<unsigned char>& imagen, string provincia);
};