...
int main() {
    ...
    while (resp == false) {
        ...
        if (options == 4) {
            c.Graficar_Poblaciones(img);
            img1 = img;
        }
        if (options == 5) {
            a.Graficar_Escuelas(img);
        }
        if (options == 6) {
        ...
        if (options == 7) {
            ...
            switch (opcion) {
            case 1:
                b.Graficar_ColegioParametro(img); break;
            case 2:
                a.Graficar_EscuelasParametro(img); break;
        ...
        if (options == 9) {
            ...
            switch (opcion) {
            case 1:
                c.Parametro_Poblados(ListaP,img); break;
            case 2:
                b.Parametro_Colegio(ListaC, img); break;
            case 3: 
                a.Parametro_Escuelas(ListaE, img); break;
            default: cout << "Digite el numero correcto" << endl;
            }
        }
        if (options == 10) {
            ...
            switch (opcion) {
            case 1:
                b.DosParametro_Colegio(ListaC, img); break;
            case 2:
                a.DosParametro_Escuelas(ListaE, img); break;
            default: cout << "Digite el numero correcto" << endl;
            }
        }
    }
